<nav class="mb-24 h-24 w-full flex items-center justify-between">
  <h2 class="mr-auto text-center text-xl font-semibold tracking-tight">
    Cleanbg
  </h2>
  <ul class="flex items-center justify-center gap-6">
    ...
    <li>
      <a href="https://dpg-code.vercel.app/" target="_blank">
        <svg
          width="24px"
          height="24px"
          stroke-width="1.5"
